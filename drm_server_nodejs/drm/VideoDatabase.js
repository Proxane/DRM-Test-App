(function () {
    ...
    let allVideos = [
        ...
        */
		...
		{
			"name": "Plane video",
			"url": "https://localhost:4000/videos/Video1/Encrypted_Cenc/Manifest.mpd",
			"keys": [
				{
					"keyId": "06d8aae7-dea0-4222-b5d7-891933987d9b"
				} 
			],
            "license": "free"
        },
        {
			"name": "Beach video",
			"url": "https://localhost:4000/videos/Video2/Encrypted_Cenc/Manifest.mpd",
			"keys": [
				{
					"keyId": "b4d87a79-1c13-4fdb-b593-206bc0a9af32"
				} 
			],
            "license": "premium"
		}
    ...
    module.exports = {
        ...
        "getVideosByPermission": function getVideosByPermission(permission) {
            return allVideos.filter(item => {
                return item.license === permission
            })
        }
    };
})();